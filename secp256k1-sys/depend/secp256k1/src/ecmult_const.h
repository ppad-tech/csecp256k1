...
/**
 * Same as haskellsecp256k1_v0_1_0_ecmult_const, but takes in an x coordinate of the base point
 ...
 */
static int haskellsecp256k1_v0_1_0_ecmult_const_xonly(
    haskellsecp256k1_v0_1_0_fe *r,
    const haskellsecp256k1_v0_1_0_fe *n,
    const haskellsecp256k1_v0_1_0_fe *d,
    const haskellsecp256k1_v0_1_0_scalar *q,
    int known_on_curve
);
