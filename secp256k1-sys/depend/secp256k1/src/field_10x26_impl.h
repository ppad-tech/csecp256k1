...
void haskellsecp256k1_v0_1_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b);
void haskellsecp256k1_v0_1_0_fe_sqr_inner(uint32_t *r, const uint32_t *a);

#else

#define VERIFY_BITS(x, n) VERIFY_CHECK(((x) >> (n)) == 0)

SECP256K1_INLINE static void haskellsecp256k1_v0_1_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
SECP256K1_INLINE static void haskellsecp256k1_v0_1_0_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
static void haskellsecp256k1_v0_1_0_fe_from_signed30(haskellsecp256k1_v0_1_0_fe *r, const haskellsecp256k1_v0_1_0_modinv32_signed30 *a) {
...
static void haskellsecp256k1_v0_1_0_fe_to_signed30(haskellsecp256k1_v0_1_0_modinv32_signed30 *r, const haskellsecp256k1_v0_1_0_fe *a) {
...
static const haskellsecp256k1_v0_1_0_modinv32_modinfo haskellsecp256k1_v0_1_0_const_modinfo_fe = {
...
static void haskellsecp256k1_v0_1_0_fe_impl_inv(haskellsecp256k1_v0_1_0_fe *r, const haskellsecp256k1_v0_1_0_fe *x) {
    ...
    haskellsecp256k1_v0_1_0_fe_to_signed30(&s, &tmp);
    haskellsecp256k1_v0_1_0_modinv32(&s, &haskellsecp256k1_v0_1_0_const_modinfo_fe);
    haskellsecp256k1_v0_1_0_fe_from_signed30(r, &s);
}
...
static void haskellsecp256k1_v0_1_0_fe_impl_inv_var(haskellsecp256k1_v0_1_0_fe *r, const haskellsecp256k1_v0_1_0_fe *x) {
    ...
    haskellsecp256k1_v0_1_0_fe_to_signed30(&s, &tmp);
    haskellsecp256k1_v0_1_0_modinv32_var(&s, &haskellsecp256k1_v0_1_0_const_modinfo_fe);
    haskellsecp256k1_v0_1_0_fe_from_signed30(r, &s);
}
...
static int haskellsecp256k1_v0_1_0_fe_impl_is_square_var(const haskellsecp256k1_v0_1_0_fe *x) {
    ...
    tmp = *x;
    haskellsecp256k1_v0_1_0_fe_normalize_var(&tmp);
    /* haskellsecp256k1_v0_1_0_jacobi32_maybe_var cannot deal with input 0. */
    if (haskellsecp256k1_v0_1_0_fe_is_zero(&tmp)) return 1;
    haskellsecp256k1_v0_1_0_fe_to_signed30(&s, &tmp);
    jac = haskellsecp256k1_v0_1_0_jacobi32_maybe_var(&s, &haskellsecp256k1_v0_1_0_const_modinfo_fe);
    if (jac == 0) {
        /* haskellsecp256k1_v0_1_0_jacobi32_maybe_var failed to compute the Jacobi symbol. Fall back
