...
typedef struct {
    ...
    haskellsecp256k1_v0_1_0_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} haskellsecp256k1_v0_1_0_modinv32_modinfo;
...
/* Same as haskellsecp256k1_v0_1_0_modinv32_var, but constant time in x (not in the modulus). */
