...
#ifdef VERIFY
static const haskellsecp256k1_v0_1_0_modinv32_signed30 SECP256K1_SIGNED30_ONE = {{1}};

/* Compute a*factor and put it in r. All but the top limb in r will be in range [0,2^30). */
static void haskellsecp256k1_v0_1_0_modinv32_mul_30(haskellsecp256k1_v0_1_0_modinv32_signed30 *r, const haskellsecp256k1_v0_1_0_modinv32_signed30 *a, int alen, int32_t factor) {
...
static int haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(const haskellsecp256k1_v0_1_0_modinv32_signed30 *a, int alen, const haskellsecp256k1_v0_1_0_modinv32_signed30 *b, int32_t factor) {
    int i;
    haskellsecp256k1_v0_1_0_modinv32_signed30 am, bm;
    haskellsecp256k1_v0_1_0_modinv32_mul_30(&am, a, alen, 1); /* Normalize all but the top limb of a. */
    haskellsecp256k1_v0_1_0_modinv32_mul_30(&bm, b, 9, factor);
    for (i = 0; i < 8; ++i) {
 ...
 * [0,2^30). */
static void haskellsecp256k1_v0_1_0_modinv32_normalize_30(haskellsecp256k1_v0_1_0_modinv32_signed30 *r, int32_t sign, const haskellsecp256k1_v0_1_0_modinv32_modinfo *modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    ...
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, -2) > 0); /* r > -2*modulus */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
    ...
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 0) >= 0); /* r >= 0 */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
}
...
typedef struct {
    int32_t u, v, q, r;
} haskellsecp256k1_v0_1_0_modinv32_trans2x2;
 ...
 */
static int32_t haskellsecp256k1_v0_1_0_modinv32_divsteps_30(int32_t zeta, uint32_t f0, uint32_t g0, haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t) {
...
/* haskellsecp256k1_v0_1_0_modinv32_inv256[i] = -(2*i+1)^-1 (mod 256) */
static const uint8_t haskellsecp256k1_v0_1_0_modinv32_inv256[128] = {
 ...
 */
static int32_t haskellsecp256k1_v0_1_0_modinv32_divsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0, haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t) {
    /* Transformation matrix; see comments in haskellsecp256k1_v0_1_0_modinv32_divsteps_30. */
    uint32_t u = 1, v = 0, q = 0, r = 1;
    ...
    for (;;) {
        ...
        zeros = haskellsecp256k1_v0_1_0_ctz32_var(g | (UINT32_MAX << i));
        ...
        w = (g * haskellsecp256k1_v0_1_0_modinv32_inv256[(f >> 1) & 127]) & m;
        /* Do so. */
        g += f * w;
        q += u * w;
        r += v * w;
 ...
 * Return: final eta
 */
static int32_t haskellsecp256k1_v0_1_0_modinv32_posdivsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0, haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t, int *jacp) {
 ...
 */
static void haskellsecp256k1_v0_1_0_modinv32_update_de_30(haskellsecp256k1_v0_1_0_modinv32_signed30 *d, haskellsecp256k1_v0_1_0_modinv32_signed30 *e, const haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t, const haskellsecp256k1_v0_1_0_modinv32_modinfo* modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t di, ei, md, me, sd, se;
    int64_t cd, ce;
    int i;
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, -2) > 0); /* d > -2*modulus */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, 1) < 0);  /* d <    modulus */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, -2) > 0); /* e > -2*modulus */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, 1) < 0);  /* e <    modulus */
 ...
 */
static void haskellsecp256k1_v0_1_0_modinv32_update_fg_30(haskellsecp256k1_v0_1_0_modinv32_signed30 *f, haskellsecp256k1_v0_1_0_modinv32_signed30 *g, const haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
 ...
 */
static void haskellsecp256k1_v0_1_0_modinv32_update_fg_30_var(int len, haskellsecp256k1_v0_1_0_modinv32_signed30 *f, haskellsecp256k1_v0_1_0_modinv32_signed30 *g, const haskellsecp256k1_v0_1_0_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
...
static void haskellsecp256k1_v0_1_0_modinv32(haskellsecp256k1_v0_1_0_modinv32_signed30 *x, const haskellsecp256k1_v0_1_0_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, zeta=-1. */
    haskellsecp256k1_v0_1_0_modinv32_signed30 d = {{0}};
    haskellsecp256k1_v0_1_0_modinv32_signed30 e = {{1}};
    haskellsecp256k1_v0_1_0_modinv32_signed30 f = modinfo->modulus;
    haskellsecp256k1_v0_1_0_modinv32_signed30 g = *x;
    int i;
    ...
    for (i = 0; i < 20; ++i) {
        ...
        haskellsecp256k1_v0_1_0_modinv32_trans2x2 t;
        zeta = haskellsecp256k1_v0_1_0_modinv32_divsteps_30(zeta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        haskellsecp256k1_v0_1_0_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, 1) < 0);  /* g <  modulus */

        haskellsecp256k1_v0_1_0_modinv32_update_fg_30(&f, &g, &t);
    ...
    /* g == 0 */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, 9, &SECP256K1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &SECP256K1_SIGNED30_ONE, -1) == 0 ||
                 haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &SECP256K1_SIGNED30_ONE, 1) == 0 ||
                 (haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(x, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&d, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  (haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) == 0 ||
                   haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) == 0)));

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    haskellsecp256k1_v0_1_0_modinv32_normalize_30(&d, f.v[8], modinfo);
    *x = d;
}

/* Compute the inverse of x modulo modinfo->modulus, and replace x with it (variable time). */
static void haskellsecp256k1_v0_1_0_modinv32_var(haskellsecp256k1_v0_1_0_modinv32_signed30 *x, const haskellsecp256k1_v0_1_0_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, eta=-1. */
    haskellsecp256k1_v0_1_0_modinv32_signed30 d = {{0, 0, 0, 0, 0, 0, 0, 0, 0}};
    haskellsecp256k1_v0_1_0_modinv32_signed30 e = {{1, 0, 0, 0, 0, 0, 0, 0, 0}};
    haskellsecp256k1_v0_1_0_modinv32_signed30 f = modinfo->modulus;
    haskellsecp256k1_v0_1_0_modinv32_signed30 g = *x;
#ifdef VERIFY
    int i = 0;
    ...
    while (1) {
        ...
        haskellsecp256k1_v0_1_0_modinv32_trans2x2 t;
        eta = haskellsecp256k1_v0_1_0_modinv32_divsteps_30_var(eta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        haskellsecp256k1_v0_1_0_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */

        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 1) < 0);  /* g <  modulus */

        haskellsecp256k1_v0_1_0_modinv32_update_fg_30_var(len, &f, &g, &t);
    ...
    /* g == 0 */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, len, &SECP256K1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &SECP256K1_SIGNED30_ONE, -1) == 0 ||
                 haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &SECP256K1_SIGNED30_ONE, 1) == 0 ||
                 (haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(x, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&d, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  (haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) == 0 ||
                   haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) == 0)));

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    haskellsecp256k1_v0_1_0_modinv32_normalize_30(&d, f.v[len - 1], modinfo);
    *x = d;
}
...
static int haskellsecp256k1_v0_1_0_jacobi32_maybe_var(const haskellsecp256k1_v0_1_0_modinv32_signed30 *x, const haskellsecp256k1_v0_1_0_modinv32_modinfo *modinfo) {
    ...
    for (count = 0; count < JACOBI32_ITERATIONS; ++count) {
        ...
        haskellsecp256k1_v0_1_0_modinv32_trans2x2 t;
        eta = haskellsecp256k1_v0_1_0_modinv32_posdivsteps_30_var(eta, f.v[0] | ((uint32_t)f.v[1] << 30), g.v[0] | ((uint32_t)g.v[1] << 30), &t, &jac);
        /* Update f,g using that transition matrix. */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 0) > 0); /* f > 0 */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 0) > 0); /* g > 0 */
        VERIFY_CHECK(haskellsecp256k1_v0_1_0_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 1) < 0);  /* g < modulus */
