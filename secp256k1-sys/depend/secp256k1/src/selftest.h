...
static int haskellsecp256k1_v0_1_0_selftest_sha256(void) {
    ...
    haskellsecp256k1_v0_1_0_sha256_write(&hasher, (const unsigned char*)input63, 63);
    haskellsecp256k1_v0_1_0_sha256_finalize(&hasher, out);
    return haskellsecp256k1_v0_1_0_memcmp_var(out, output32, 32) == 0;
}

static int haskellsecp256k1_v0_1_0_selftest_passes(void) {
    return haskellsecp256k1_v0_1_0_selftest_sha256();
}
